...
async function crearUsuario() {
    try {
        const res = await fetch('https://playground.4geeks.com/todo/users/tony42cadiz', {
            method: "POST",
            headers: {
...
async function leerUsuario() {
    try {
        const resultado = await fetch('https://playground.4geeks.com/todo/users/tony42cadiz');
...
const Home = () => {
    ...
    return (
        <div className="container w-50 text-center">
            <label htmlFor="exampleInputEmail1" className="form-label" style={{ fontSize: "30px", paddingTop: "10px" }}>TodoList</label>
